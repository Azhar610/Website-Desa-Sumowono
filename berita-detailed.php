<?php
// Data dummy untuk satu item berita.
$detailBerita = [
    'judul' => 'Pembangunan Balai Desa Tahap Akhir Hampir Selesai',
    'tanggal' => '22 September 2025',
    'penulis' => 'Admin Desa',
    'dilihat' => 100,
    'gambar' => 'https://placehold.co/800x450/D9D9D9/888888?text=Gambar+Berita+Utama',
...
<head>
    ...
    <title><?= htmlspecialchars($detailBerita['judul']) ?> - Desa Sumowono</title>
        ...
        <main class="main-content">
            <div class="tabs-container">
                <div class="tabs">
                    ...
                    <a href="berita-dan-artikel.php?tab=berita" class="tab-button active">BERITA</a>
                    <a href="berita-dan-artikel.php?tab=artikel" class="tab-button">ARTIKEL</a>
                </div>
                ...
                <header class="article-header">
                    ...
                    <div class="article-meta">
                        <span class="meta-item">
                            ...
                            <?= htmlspecialchars($detailBerita['tanggal']) ?>
                        </span>
                        <span class="meta-item">
                            ...
                            <?= htmlspecialchars($detailBerita['penulis']) ?>
                        </span>
                        <span class="meta-item">
                            ...
                            <?= htmlspecialchars($detailBerita['dilihat']) ?>
                        </span>
                    </div>
                </header>
                <figure class="article-image-container">
                    <img src="<?= htmlspecialchars($detailBerita['gambar']) ?>" alt="Gambar utama untuk <?= htmlspecialchars($detailBerita['judul']) ?>">
                    <figcaption>Gambar 1. Contoh</figcaption>
                </figure>
                <section class="article-content">
                    <p><?= nl2br(htmlspecialchars($detailBerita['konten'])) ?></p>
                </section>
